...
function readQuote() {
    db.collection("quoteOfTheDay").doc("Tuesday")                                               //name of the collection and documents should matach excatly with what you have in Firestore
...
db.collection("quoteOfTheDay").doc("Tuesday")
    ...
    function writeHikes() {
        ...
        hikesRef.add({
            ...
            level: "easy",
            length: "10",
            details: "Jackson loves to go here with his friends",
        ...
        hikesRef.add({
            ...
            level: "moderate",
            length: "10.5",
            details: "Jackson thinks that is the best hike for him",
            last_updated: firebase.firestore.FieldValue.serverTimestamp()
       });
       hikesRef.add({
            code:"NV01",
            ...
            level: "hard",
            length: "8.2",
            details: "Jackson would recommend you to go here this weekend",
